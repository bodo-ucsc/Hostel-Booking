...
class ViewCardProperty
{
    public function __construct($placeid,  $city = null, $houseNo = null, $street = null, $imgLink = null, $noofmembers = null)
    {
        ...
        echo "
            <button class=' bg-white border-1 border-black white-hover margin-top-3 border-rounded-more'><a class=' black' href= $base/property/viewABoardingPlace/$placeid>View Property</a></button>
            </div>
            </div>
        ";
    }
