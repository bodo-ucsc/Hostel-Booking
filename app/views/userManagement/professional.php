        ...
        <div class="col-12 col-small-12 width-90">
            <div class="row no-gap">
                ...
                <div class="col-9 col-small-10 col-large-9 fill-container left">
                    <?php $search = new SearchUser("Professional") ?>
                </div>
                <div class="col-1 display-small-none"></div>
                <div class="col-2 col-large-3 fill-container right">
                    <button class="bg-blue white border-rounded header-nb padding-3 right" onclick="location.href='<?php echo $base ?>/create/professional'">
                        ...
                        <div
                            ...
                            if (isset($useridArray)) {
                                foreach ($useridArray as $userid) {
                                    ...
                                    echo "<a href='" . $base . "/userEdit/professional/$userid'><div class=' fill-container border-blue bg-white blue-hover border-1 border-rounded padding-vertical-1  center'>";
