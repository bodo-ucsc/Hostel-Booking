...
$basePage = BASEURL . '/verification/professional';
$base = BASEURL;
?>
                            ...
                            if (isset($data['result'])) {
                                ...
                                foreach ($data['result'] as $key => $value) {
                                    ...
                                    if ($verifiedStatus != "verified") {
                                        ...
                                        echo "<div id='result-$userid' class='hs list-items padding-horizontal-5 padding-vertical-2 border-1 border-white'>";
...
<script>
    ...
    function verify(id) {
        let url = "<?= $base ?>/verification/verify/Professional/";
