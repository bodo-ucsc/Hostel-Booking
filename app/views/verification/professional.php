...
$sidebar = new SidebarNav("verification", "professional");
                        ...
                        <div
                            ...
                            if (isset($useridArray)) {
                                foreach ($useridArray as $userid) {
                                    ...
                                    echo "<a href='" . $base . "/view/professional/$userid'><div class=' fill-container  border-accent bg-white accent-hover border-1 border-rounded padding-vertical-1  center'>";
                                    ...
                                    echo "<div class='col-4 fill-container '>";
                                    echo "<a href='" . $base . "/verify/professional/$userid'><div class=' fill-container border-blue bg-white blue-hover border-1 border-rounded padding-vertical-1  center'>";
