    ...
    ?>
        ...
        <div class="container margin-top-5 padding-top-5">
            ...
            <form action="<?php echo BASEURL; ?>adminhome/updateboardingOwner" method="POST">
                ...
                <!-- <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($row['user_id'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>First Name</label>
            <input type="text" name="first_name" value="<?php echo htmlspecialchars($row['first_name'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>Last Name</label>
            <input type="text" name="lasst_name" value="<?php echo htmlspecialchars($row['lasst_name'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>NIC</label>
            <input type="text" name="first_name" value="<?php echo htmlspecialchars($row['first_name'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>Email</label>
            <input type="email" name="email" value="<?php echo htmlspecialchars($row['email'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>DOB</label>
            <input type="text" name="DOB" value="<?php echo htmlspecialchars($row['DOB'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>Gender</label>
            <input type="text" name="gender" value="<?php echo htmlspecialchars($row['gender'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>Address</label>
            <input type="text" name="address" value="<?php echo htmlspecialchars($row['address'], ENT_QUOTES, 'UTF-8'); ?>" /><br>
            <label>Contact No</label>
            <input type="text" name="contactNo" value="<?php echo htmlspecialchars($row['contactNo'], ENT_QUOTES, 'UTF-8'); ?>" /><br><br>
