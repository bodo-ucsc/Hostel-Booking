...
<body>
  ...
  <div class=" margin-top-5 margin-vertical-5 padding-top-5 position-absolute">
    <div class="">
      <ul>
      ...
      <div class=" margin-left-5 full-height">
        <div>
          ...
          <div class=" ">
            ...
            <h2 class="header-1">Professional page Still under construction</h2>
            <!-- <button class=" bg-neutral"><a href="addProfessionl">Add Professionl</a></button></br></br> -->
          </div>
