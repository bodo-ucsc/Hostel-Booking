...
public function utilityupload()
    {
        // Exit if no file uploaded
        if (!isset($_FILES["utilityupload"])) {
            die('No file uploaded.');
        }
        $image_file = $_FILES["utilityupload"];
        ...
        move_uploaded_file(
            ...
            // New image location
            PATH . "/public/images/upload/utility/" . $image_name
        );

        echo json_encode(array("filepath" => "images/upload/utility/" . $image_name));
    }
    ...
    {
        // Exit if no file uploaded
        if (!isset($_FILES["supportimage"])) {
            die('No file uploaded.');
        }
        $image_file = $_FILES["supportimage"];
        ...
        move_uploaded_file(
            ...
            // New image location
            PATH . "/public/images/upload/support/" . $image_name
        );

        echo json_encode(array("filepath" => "images/upload/support/" . $image_name));
    }
    public function listingImages()
    {
        // Exit if no file uploaded
        if (!isset($_FILES["listingImages"])) {
            die('No file uploaded.');
        }
        $image_file = $_FILES["listingImages"];
        ...
        move_uploaded_file(
            ...
            // New image location
            PATH . "/public/images/upload/place/" . $image_name
        );

        echo json_encode(array("filepath" => "images/upload/place/" . $image_name));
    }
