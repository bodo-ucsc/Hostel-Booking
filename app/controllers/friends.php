...
class friends extends Controller
{
    ...
    {
        $result = $this->model('viewModel')->checkData("friend,user,student", "user.UserId = friend.FriendId AND student.StudentId = friend.FriendId AND friend.StudentFriendId='$userid'");
